...
const INVALID_AMOUNT_MESSAGE = "Enter a number, like 40000 or 40,000.50";
 ...
 * and spaces are stripped before parsing. A blank field is 'blank' (the row
 * logic decides what that means); anything non-blank that still doesn't parse
 * to a finite number >= 0 is 'invalid' and must block submission — silently
 * reading it as zero would produce a confidently wrong verdict.
 */
function parsePounds(raw: string): number | "blank" | "invalid" {
