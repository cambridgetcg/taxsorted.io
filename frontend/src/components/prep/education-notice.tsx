 ...
 * arithmetic, not advice, and no production filing is available.
 * The status claims stay visible on every page — never behind a disclosure:
 * a reader must not need a click to learn that the labelled submission path
 * reaches HMRC's sandbox only.
  ...
  return (
    ...
    >
      <p>
        ...
        cannot file to live HMRC. Only the clearly labelled practice flow can send figures to
        HMRC&apos;s sandbox.
      </p>
