...
Every level gets the same hygiene: UI, UX, code, modules, filing, categorising. Plain names.
One job per piece. No dead weight. We measure it (`pomp`) and keep the score honest.
