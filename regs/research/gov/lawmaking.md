...
- Committee stage is **split**: the politically biggest clauses are debated in **Committee of the Whole House** (all MPs, on the floor), the rest go to a **Public Bill Committee** (small committee of MPs).
  Source: parliament.uk Scrutiny Unit guidance [snippet — "some key clauses of Finance Bills are considered by the Committee of the Whole House rather than a Public Bill Committee"] https://www.parliament.uk/mps-lords-and-offices/offices/commons/scrutinyunit/written-submissions/ ; corroborated by the real FA2026 timeline below (CWH + PBC split for FB2025-26 re-verified LIVE 2026-07-06 via the CIOT tracker, §3). Confidence: HIGH.
- **Anyone can submit written evidence to the Public Bill Committee** — email scrutiny@parliament.uk. RE-VERIFIED 2026-07-06 against the Wayback Machine archived copy of the parliament.uk page (snapshot 4 Aug 2025 — https://web.archive.org/web/20250804223350/https://www.parliament.uk/mps-lords-and-offices/offices/commons/scrutinyunit/written-submissions/ ; the live page still 403s to automated fetch). Email CONFIRMED. Verbatim on the page: "submissions sent to the Government department in charge of the Bill will not be treated as evidence to the Public Bill Committee"; "Submissions can be accepted after the second reading debate on the bill. The sooner you send the evidence to us, the better." Confidence: HIGH for email + department rule + timing.
  ⚠ CORRECTION 2026-07-06: the earlier search-extract details "Word document, max 3,000 words, before the committee's last sitting" are NOT on the archived page — they likely belong to the separate select-committee submission guidelines the page links to. Treat those three details as UNVERIFIED for PBCs; do not publish them as PBC rules.
...
- So the Lords cannot block or amend tax rates. Their real influence is earlier and technical: the **House of Lords Economic Affairs Committee's Finance Bill Sub-Committee**, appointed annually, examines the **draft** Finance Bill "from the point of view of technical issues of tax administration, clarification and simplification" — explicitly NOT rates or incidence. For Finance Bill 2025-26 it opened its inquiry ("Draft Finance Bill 2025–26") on 17 September 2025 with a written-evidence window 17 September – 7 October 2025 (draft bill published 21 July 2025), and published a report (news item "Lords Committee publishes report on Finance Bill 2025-26" [snippet]).
  Source: https://committees.parliament.uk/committee/230/finance-bill-subcommittee/ . RE-VERIFIED LIVE 2026-07-06 via Parliament's open committees API (not Cloudflare-challenged): purpose verbatim from https://committees-api.parliament.uk/api/Committees/230 — "The Economic Affairs Finance Bill Sub-Committee considers aspects of the Finance Bill from the point of view of technical issues of tax administration, clarification and simplification"; inquiry open date + evidence window from https://committees-api.parliament.uk/api/CommitteeBusiness?CommitteeId=230 (inquiry "Draft Finance Bill 2025–26", open 2025-09-17, WrittenEvidence submission period 2025-09-17T10:00 → 2025-10-07T17:00). Confidence: HIGH (remit + 2025 dates).
  ⚠ The earlier "appointed 2 September 2025" date was NOT confirmed by the API (it lists inquiry dates, not appointment) — still [snippet]/MEDIUM; dropped from published copy.
...
| 16 Dec 2025 | Second reading (Commons) | CIOT https://www.tax.org.uk/finance-bill-2025-26 — RE-VERIFIED LIVE 2026-07-06 (curl with browser UA, HTTP 200), HIGH |
| 12–13 Jan 2026 | Committee of the Whole House (selected clauses) | CIOT (re-verified live 2026-07-06), HIGH; gov.uk supporting doc "Finance Bill 2025-26: Committee of the Whole House" https://www.gov.uk/government/publications/finance-bill-2025-26-committee-of-the-whole-house |
| 27 Jan–3 Feb 2026 | Public Bill Committee, six sittings (27 Jan, 29 Jan, 3 Feb — two per day); committee stage completed 3 Feb 2026 | CIOT (re-verified live 2026-07-06), HIGH |
| 11 Mar 2026 | Remaining stages (report + third reading) | CIOT (re-verified live 2026-07-06), HIGH; "substantively enacted" for accounting that day per rossmartin.co.uk (above), MEDIUM |
...
- **Tax SIs are usually laid before the House of Commons only** (financial privilege). Live example: **SI 2026/336, The Income Tax (Digital Obligations) Regulations 2026** — made by "the Commissioners for His Majesty's Revenue and Customs" on **23 March 2026**, **laid before the House of Commons** (only) **24 March 2026**, in force **1 April 2026**; made under paras 7, 9, 11, 13–15 and 18 of Schedule A1 to the Taxes Management Act 1970 (inserted by Finance (No. 2) Act 2017).
  ...
  Procedure type: **negative procedure — CONFIRMED, HIGH.** RE-VERIFIED 2026-07-06 from the SI's Explanatory Memorandum, https://www.legislation.gov.uk/uksi/2026/336/memorandum (PDF at /uksi/2026/336/pdfs/uksiem_20260336_en_001.pdf, fetched 2026-07-06). Para 12.1 verbatim: "As the instrument is subject to negative procedure and does not amend primary legislation no statement is required." Bonus facts from the same EM: prepared by HMRC, laid before the House of Commons only (para 1.1); regulation 36 revokes SI 2021/1076 and SI 2024/167 (para 6.2); affects ~2.9 million unincorporated businesses and landlords (para 9.1); came into force less than 21 days after laying because it had to follow FA 2026 Royal Assent (para 11.2).
...
- What replaced it: a **mandate to HMT/HMRC officials** to focus on simplification inside normal policy work (announced alongside closure), i.e. simplification lost its independent institutional champion. Treasury Committee members TABLED report-stage amendments to the Finance (No. 2) Bill: Amendment 7 (leave out the abolition clause, then Clause 346) and **New Clause 2** ("seeks to place a statutory requirement on the Treasury to report annually to the Treasury Committee on steps taken to simplify the tax system" — verbatim, para 24 of the report). RE-VERIFIED 2026-07-06 against the archived copy of the Treasury Committee report https://publications.parliament.uk/pa/cm5803/cmselect/cmtreasy/1425/report.html (Wayback snapshot 9 Dec 2023 — report text is immutable once published; live page 403s to automated fetch). Confidence: HIGH for the tabling + the report's recommendation.
  ⚠ CORRECTION 2026-07-06: the earlier "debated and rejected" outcome claim could NOT be verified (the report predates the outcome; bills.parliament.uk unfetchable). What IS verifiable: the abolition was enacted (s.347 F(No.2)A 2023) and no reporting duty appears in that Act — publish "tabled; abolition enacted regardless", not "rejected". Also note: the amendment was NC**2**, not NC1 as the earlier snippet said.
...
- parliament.uk facts: re-verification pass DONE 2026-07-06 (gov-pillar Task 2 review fixes). PBC email + department rule: verified via Wayback snapshot (§2.3 — with a correction: Word/3,000-word/last-sitting details were wrong). Lords FBSC remit + 2025 evidence window: verified live via committees-api (§2.4; appointment date still unverified). FA2026 intermediate stage dates: verified live via CIOT (§3). OTS amendment: verified TABLED via archived Treasury Committee report (§6 — "rejected" corrected to "enacted regardless"; NC2 not NC1). SI 2026/336 negative procedure: verified from its Explanatory Memorandum (§4). Still open: FBSC appointment date (2 Sep 2025), the Bill-publication 2 vs 4 Dec 2025 discrepancy below.
