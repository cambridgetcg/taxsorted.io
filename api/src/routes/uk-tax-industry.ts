...
function cacheableJson(c: Context, corpus: UkTaxIndustry, value: unknown) {
      ...
      return c.json(
        {
          ...
          message: "The reviewed source ledger and gap register remain public while the full industry map is closed.",
