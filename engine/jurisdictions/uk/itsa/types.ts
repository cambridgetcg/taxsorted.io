...
/**
 * The tax engine's ready projection. Import evidence, review state and edit
 * history belong to the local books layer; this shape contains only what a
 * calculation needs.
 */
export interface LedgerRecord {
  ...
  source: SourceType
  description?: string
  /** Refunds and reversals reduce a category without confusing cash direction with tax treatment. */
  effect?: 'increase' | 'decrease'
}

export type NewLedgerRecord = Omit<LedgerRecord, 'id'>
